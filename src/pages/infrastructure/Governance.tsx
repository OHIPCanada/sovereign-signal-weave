...
const frameworks = [
  {
    icon: Globe,
    title: "PIPEDA",
    subtitle: "Federal Privacy Law",
    desc: "Full compliance with Canada's Personal Information Protection and Electronic Documents Act. Built-in consent management, purpose limitation, and data minimization.",
  },
  {
    icon: ShieldCheck,
    title: "PHIPA",
    subtitle: "Ontario Health Privacy",
    desc: "Comprehensive adherence to the Personal Health Information Protection Act. Custodian controls, access logging, and breach notification workflows.",
  },
  {
    icon: FileText,
    title: "Provincial Acts",
    subtitle: "BC, Alberta, Quebec",
    desc: "Multi-jurisdictional governance layer supporting PIPA (BC/AB) and Quebec's Law 25. Automatic policy routing based on data origin.",
  },
  {
    icon: Scale,
    title: "ISO 42001",
    subtitle: "AI Management",
    desc: "Aligned with the international standard for AI management systems. Risk assessment, human oversight, and algorithmic accountability.",
  },
];
...
const principles = [
  {
    ...
    desc: "Only collect and process what's clinically necessary. Automated redaction and anonymization at the infrastructure level.",
  },
  {
    icon: Users,
    title: "Purpose Limitation",
    desc: "Every data access is tied to a specific, documented purpose. No secondary use without explicit consent.",
  },
  {
    icon: ShieldCheck,
    title: "Accountability",
    desc: "Clear chain of responsibility from data collection to deletion. Every processing activity has an owner.",
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-[0.55fr_1.45fr] items-center split-layout-gap">
          ...
          >
            ...
            <p style={{ color: "rgba(255,255,255,0.72)", fontWeight: 400, fontSize: "clamp(15px, 1.25vw, 18px)", lineHeight: 1.55, maxWidth: "46ch" }}>
              Data governance isn't a checkbox — it's wired into how we store, route, and process every clinical signal. PIPEDA, PHIPA, and provincial acts enforced at the infrastructure level.
            </p>
          </motion.div>
          ...
          {frameworks.map((fw, i) => (
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontWeight: 400, fontSize: 14, color: "rgba(30,30,30,0.65)", lineHeight: 1.55 }}>
                  {fw.desc}
                </div>
              </div>
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {principles.map((p, i) => (
              ...
              >
                ...
                <div style={{ fontWeight: 700, fontSize: 16, color: "rgba(255,255,255,0.95)", marginBottom: 8 }}>
                  {p.title}
                </div>
