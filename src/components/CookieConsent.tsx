...
const ConsentBannerContent = forwardRef<HTMLDivElement, {
  preferences: ConsentPreferences;
  showDetails: boolean;
  setShowDetails: (val: boolean) => void;
  togglePreference: (key: "analytics" | "marketing") => void;
  acceptAll: () => void;
  acceptSelected: () => void;
  rejectNonEssential: () => void;
}>(({ preferences, showDetails, setShowDetails, togglePreference, acceptAll, acceptSelected, rejectNonEssential }, ref) => (
  <div
    ref={ref}
