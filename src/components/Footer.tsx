      ...
      >
        ...
        >
          ...
          <div className="flex gap-3.5 items-center flex-wrap">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512" fill="#ef4444">
                <path d="M383.8 132.2c-2.6-1.4-5.8-.4-7.2 2.2l-42.4 77.6-64-33.2c-1.6-.8-3.4-.8-5 0-1.6.8-2.6 2.4-3 4.2l-6.2 42.6-47.4-19c-2.4-1-5.2 0-6.4 2.2-1.2 2.4-.6 5.2 1.4 6.8l39 30.8-38 48.4c-1.6 2-1.4 4.8.2 6.6 1 1 2.2 1.6 3.6 1.6.6 0 1.2-.2 1.8-.4l53.2-21.2-3.4 79.6c-.2 2.8 2 5.2 4.8 5.4h.4c2.6 0 4.8-2 5-4.6l7.8-79.2 53.6 20.4c.6.2 1.2.4 1.8.4 1.4 0 2.6-.6 3.6-1.6 1.6-1.8 1.8-4.6.2-6.6l-38-48.4 39-30.8c2-1.6 2.6-4.4 1.4-6.8-1.2-2.2-4-3.2-6.4-2.2l-47.4 19-6.2-42.6c-.4-1.8-1.4-3.2-3-4.2-1.6-.8-3.4-.8-5 0l-64 33.2-42.4-77.6c-1.4-2.6-4.6-3.6-7.2-2.2-2.6 1.4-3.6 4.6-2.2 7.2l46 84.2c1 1.8 2.8 3 4.8 3.2 2 .2 3.8-.6 5.2-2l58.6-30.4 5.6 38.6-43.2 17.2c-2 .8-3.4 2.6-3.6 4.8-.2 2.2.8 4.2 2.6 5.4l33.4 26.4-33.4 42.4 48.4-19.2-7 71.6 7.2-71.4 48.2 18.4-33.4-42.4 33.4-26.4c1.8-1.2 2.8-3.2 2.6-5.4-.2-2.2-1.6-4-3.6-4.8l-43.2-17.2 5.6-38.6 58.6 30.4c1.4 1.4 3.2 2.2 5.2 2 2-.2 3.8-1.4 4.8-3.2l46-84.2c1.4-2.6.4-5.8-2.2-7.2z"/>
              </svg>
              Built in Canada.
            </span>
          </div>
