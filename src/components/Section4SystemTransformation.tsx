  ...
  return (
    ...
    >
       <div className="relative z-10 max-w-[1280px] mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.3fr] gap-16 lg:gap-20 items-center w-full">
        {/* Left content */}
        ...
        <div>
          <div
            ref={wrapRef}
            className="relative aspect-[7/5] rounded-[40px] overflow-hidden border border-white/10 bg-white/[0.03]"
            style={{
